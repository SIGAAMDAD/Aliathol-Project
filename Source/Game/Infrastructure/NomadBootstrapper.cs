	...
	public sealed partial class NomadBootstrapper : Node {
		...
		*/
		...
		public override void _Ready() {
			...
			_serviceFactory.RegisterSingleton<IDisplaySettingsService>( new DisplaySettingsService( cvarSystem, new GodotDisplay( GetTree().Root, cvarSystem, logger ) ) );
			...
			GodotServerRenderingBootstrapper.Initialize( _serviceFactory, _serviceLocator );
